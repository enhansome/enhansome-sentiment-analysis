# 😀😄😂😭 Awesome Sentiment Analysis 😥😟😱😤 with stars
...
Multidimensional Lexicon for Interpersonal Stancetaking [\[web\]](https://github.com/umashanthi-research/multidimensional-stance-lexicon) ⭐ 8 | 🐛 0 | 📅 2017-09-21 [\[paper\]](https://www.cc.gatech.edu/~jeisenst/papers/pavalanathan-acl-camera-ready.pdf)
...
[thisandagain/sentiment](https://github.com/thisandagain/sentiment) ⭐ 2,676 | 🐛 16 | 🌐 JavaScript | 📅 2020-05-18: Lexical, Dictionary-based, AFINN-based.

[thinkroth/Sentimental](https://github.com/thinkroth/Sentimental) ⭐ 496 | 🐛 5 | 🌐 JavaScript | 📅 2017-11-22 Lexical, Dictionary-based, AFINN-based.

### Java

[LingPipe](http://alias-i.com/): Lexical, Corpus-based, Supervised Machine Learning

[CoreNLP](https://github.com/stanfordnlp/CoreNLP) ⭐ 10,114 | 🐛 182 | 🌐 Java | 📅 2026-09-09: Supervised Machine Learning, Deep Learning
...
[nltk](http://www.nltk.org/): [VADER](https://github.com/cjhutto/vaderSentiment) ⭐ 5,061 | 🐛 56 | 🌐 Python | 📅 2026-03-02 sentiment analysis tool, Lexical, Dictionary-based, Rule-based. [\[paper\]](http://comp.social.gatech.edu/papers/icwsm14.vader.hutto.pdf)
...
[pedrobalage/SemevalAspectBasedSentimentAnalysis](https://github.com/pedrobalage/SemevalAspectBasedSentimentAnalysis) ⭐ 56 | 🐛 2 | 🌐 Python | 📅 2014-05-21: Aspect-Based, Supervised Machine Learning, Conditional Random Field.

[ganeshjawahar/mem\_absa](https://github.com/ganeshjawahar/mem_absa) ⭐ 197 | 🐛 16 | 🌐 Python | 📅 2018-03-10: Aspect-Based, Supervised Machine Learning, Deep Learning, Attention-based, External Memory. [\[paper\]](https://arxiv.org/abs/1605.08900)

[openai/generating-reviews-discovering-sentiment](https://github.com/openai/generating-reviews-discovering-sentiment) ⚠️ Archived: Deep Learning, byte mLSTM [\[paper\]](https://arxiv.org/abs/1704.01444)
...
[amrish7/Dragon](https://github.com/amrish7/Dragon) ⭐ 58 | 🐛 1 | 🌐 C# | 📅 2015-01-21: Supervised Machine Learning, Naive Bayes Classifier.
